    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="cog" :href="route('setting')" :current="request()->routeIs('setting')"
                    wire:navigate>
                    {{ __('Settings') }}
                </flux:sidebar.item>
                ...
                <flux:sidebar.item icon="academic-cap" :href="route('education')"
                    :current="request()->routeIs('education')" wire:navigate>
                    {{ __('Education') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="briefcase" :href="route('experience')"
                    :current="request()->routeIs('experience')" wire:navigate>
                    {{ __('Experience') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="cog" :href="route('technical-skills')"
                    :current="request()->routeIs('technical-skills')" wire:navigate>
                    {{ __('Technical Skills') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="heart" :href="route('personal-interests')"
                    :current="request()->routeIs('personal-interests')" wire:navigate>
